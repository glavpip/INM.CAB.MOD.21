...
real(4) time_step,            &  !Model time step (in seconds)
...
character(256) filepar,          &          !parameter file name
            ...
            blank                
character(128)  ss_ocfiles(9),   &          !files with sea surface data on oceanic grid
          ss_ocfiles_fname(9),   &          !files with sea surface data on oceanic grid (fullnames)               
...
! ss_ocfiles(3) !file with liquid river runoff 
! ss_ocfiles(4) !file with solid  river runoff 
! ss_ocfiles(5) !file with TLBC
! ss_ocfiles(6) !file with SLBC
!----------for the future needs
! ss_ocfiles(7) !file with ULBC
! ss_ocfiles(8) !file with VLBC
! ss_ocfiles(9) !file with SSHLBC
