...
integer, intent(in):: indper !index of periodicity:=0 -nonperiodic,=1 -periodic case
integer, intent(in):: nxin,nyin,nxout1,nxout2,nyout1,nyout2,fillmiss
integer, intent(in):: maskin(nxin,nyin)
real(4), intent(in):: maskout(nxout1:nxout2,nyout1:nyout2)
integer, intent(inout):: i_input(nxout1:nxout2,nyout1:nyout2,4),      &  !x-grid numbers of input grid for output grid
                         j_input(nxout1:nxout2,nyout1:nyout2,4)          !y-grid numbers of input grid for output grid
real(8), intent(inout):: matrx_elmnt_intrp(nxout1:nxout2,nyout1:nyout2,4)
real(8) sum_matr_elmnt
real(8), intent(in):: xin(nxin), yin(nyin)                    !input grid
real(8), intent(in):: xout(nxout1:nxout2,nyout1:nyout2),  &
...
integer, intent(in):: mmm_in,  mm_in,  nnn_in,  nn_in, mmm_out, mm_out, nnn_out, nn_out
...
integer, intent(in):: nxin,nyin,nxout1,nxout2,nyout1,nyout2
integer, intent(in):: mmm_out, mm_out, nnn_out, nn_out
real(4), intent(in):: funcin(nxin,nyin),undefout
real(4), intent(inout)::funcout(nxout1:nxout2,nyout1:nyout2)
real(8), intent(in):: coefficient(nxout1:nxout2,nyout1:nyout2,4)
integer, intent(in):: i_input(nxout1:nxout2,nyout1:nyout2,4),     &     !x-grid numbers of input grid for output grid
                      j_input(nxout1:nxout2,nyout1:nyout2,4)            !y-grid numbers of input grid for output grid
real(4), intent(in):: maskout(nxout1:nxout2,nyout1:nyout2)
...
integer, intent(in):: nxin,nyin,nxout1,nxout2,nyout1,nyout2
integer, intent(in):: mmm_out, mm_out, nnn_out, nn_out
real(4), intent(in):: funcin_z(nxin,nyin), funcin_m(nxin,nyin), undefout
real(4), intent(inout)::funcout_z(nxout1:nxout2,nyout1:nyout2),funcout_m(nxout1:nxout2,nyout1:nyout2)
real(8), intent(in):: coefficient(nxout1:nxout2,nyout1:nyout2,4),     &
                     rotvec_coeff(nxout1:nxout2,nyout1:nyout2,4)
real(8) func_zon_unrot,func_mer_unrot
integer, intent(in):: i_input(nxout1:nxout2,nyout1:nyout2,4),       &  !x-grid numbers of input grid for output grid
                      j_input(nxout1:nxout2,nyout1:nyout2,4)           !y-grid numbers of input grid for output grid
real(4), intent(in):: maskout(nxout1:nxout2,nyout1:nyout2)
